# -*- coding: utf-8 -*-
"""
Created on Wed May 22 17:20:45 2019

@author: LuisaB
"""

#Model 1: Naive Bayes trained on hazard specific keywords/the first wordlist
...
X = data[data.columns[5:27]]#selecting the correct columns; change numbers as needed.
y = data[data.columns[43]]#selecting the correct column; change numbers as needed.
...
conf_matrix = pd.crosstab(y_actu, y_pred, rownames=['True'], colnames=['Predicted'], margins=True)
print(conf_matrix)
...
important_features = nb.feature_log_prob_[0, :]
