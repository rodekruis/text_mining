# -*- coding: utf-8 -*-
"""
Created on Wed May 22 17:26:10 2019

@author: LuisaB
"""
##Model 2: Naive Bayes trained on all keywords/the second wordlist
#Plus the most important features
...
df_corrected = pd.read_csv(#path to csv file)

#Code partly from here: https://www.geeksforgeeks.org/learning-model-building-scikit-learn-python-machine-learning-library/
data = df_corrected
print(data)
data = data.drop("damage_x", axis = 1)
data = data.drop("wind_x", axis = 1)
...
X = data.iloc[:,np.r_[5:25, 43:98]]#selecting the correct columns; change numbers as needed.
data.columns.get_loc('categories cyclone')
y = data[data.columns[41]]#selecting the correct column; change numbers as needed.
...
# Partly from here: https://github.com/HipHoff/HipHoff/blob/master/CFPB%20Complaints/MultinomialNB.ipynb
